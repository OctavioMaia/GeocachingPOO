 ...
 */
public class InscricoesCheiasException extends Exception{
    
    /**
     * Construtor vazio, ou seja, apenas invoca o construtor da superclasse.
     */
    public InscricoesCheiasException(){
        super();
    }
     ...
     */
    public InscricoesCheiasException(String message){
        super(message);
    }
    ...
    public String getMessage() {
        return "Este evento já atingiu o limite de inscrições!\n";
    }
}
